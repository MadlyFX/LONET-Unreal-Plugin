...
class LOLEDLIVELINK_API FLoledLiveLinkSource : public ILiveLinkSource, public FRunnable
{
public:

	FLoledLiveLinkSource(FIPv4Endpoint Endpoint);

	virtual ~FLoledLiveLinkSource();
